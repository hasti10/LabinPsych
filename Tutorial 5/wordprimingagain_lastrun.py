...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\admin\\Documents\\Psychopy Experiments\\tutorial 5\\again\\wordprimingagain_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/admin/Documents/Psychopy Experiments/tutorial 5/study_words.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('test_words_referencecopy.xlsx'),
...
for thisTrial_2 in trials_2:
    ...
    time_text.text = ''
    time_text.setPos((0.4, 0.3))
    time_text.setText(round(10 - t, ndigits = 1))
    # keep track of which components have finished
    testComponents = [text_2, textbox, text_3, mouse, time_text]
    ...
    while continueRoutine and routineTimer.getTime() < 10.0:
        ...
        time_text.text = str(round(10-routineTimer.getTime()))
        ...
        if time_text.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > time_text.tStartRefresh + 10-frameTolerance:
                # keep track of stop time/frame for later
