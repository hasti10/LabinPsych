...
expName = 'sequential'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\admin\\Documents\\Psychopy Experiments\\tutorial 4\\sequential_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/admin/Documents/Psychopy Experiments/tutorial 4/sequence learning conditions.csv'),
