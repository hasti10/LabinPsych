...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\admin\\Documents\\Psychopy Experiments\\tutorial 7\\intentional binding task_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/admin/Documents/Psychopy Experiments/tutorial 7/conditions.xlsx'),
...
for thisTrial in trials:
    ...
    trialComponents = [polygon1, polygon2, key_resp]
    ...
    while continueRoutine:
        ...
        if polygon1.status == STARTED:
            ...
            if tThisFlipGlobal > polygon1.tStartRefresh + 1.0-frameTolerance:
        ...
        # *polygon2* updates
        if polygon2.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
            # keep track of start time/frame for later
            ...
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'polygon2.started')
